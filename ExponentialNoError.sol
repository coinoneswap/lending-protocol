...
contract ExponentialNoError {
     ...
     */
    function mulNeScalarTruncate(Exp memory a, uint scalar) pure internal returns (uint) {
     ...
     */
    function mulNeScalarTruncateAddUInt(Exp memory a, uint scalar, uint addend) pure internal returns (uint) {
        Exp memory product = mul_(a, scalar);
